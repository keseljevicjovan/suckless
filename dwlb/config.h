...
// font
static char *fontstr = "JetBrainsMono Nerd Font:size=9";
// tag names
...
static pixman_color_t urgent_bg_color = HEX_COLOR(0xffffffff);
static pixman_color_t middle_bg_color = HEX_COLOR(0x000000ff);
static pixman_color_t middle_bg_color_selected = HEX_COLOR(0xffffffff);
